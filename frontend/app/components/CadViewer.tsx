...
export default function CadViewer({ modelUrl = "", title = "3D CAD Model Viewer" }) {
  return (
    <div className="w-full h-full flex flex-col rounded-xl overflow-hidden bg-surface-overlay border border-border">
      {/* Viewer Header */}
      <div className="flex items-center justify-between px-4 py-3 bg-surface border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-sm font-medium text-koch-100">{title}</h3>
        </div>
        <div className="text-xs text-koch-400 font-mono flex gap-4">
